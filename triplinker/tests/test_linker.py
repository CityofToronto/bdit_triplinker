"""Pytest scripts to test linker module."""
...
from . import AUSTIN_RIDESHARE_TRIPDATA


@pytest.fixture(scope="module")
def get_feasible_austin_graph():
    # Following https://stackoverflow.com/questions/17801300/how-to-run-a-method-before-all-tests-in-all-classes
    # and https://docs.pytest.org/en/latest/fixture.html#autouse-fixtures-xunit-setup-on-steroids
